...
always @(*) begin
    case(present_state)
        ...
        START: next_state = (clk_count == (CLKS_PER_BIT/2) - 1) ? (rx_in ? IDLE : DATA) : START;    // re-sample rx_in at mid-start: still low = real start bit, gone high = glitch, return to IDLE
